...
# ---------- 📁 [ | 𝗠𝗢𝗗𝗨𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            if query.from_user.id not in ADMINS: 
                buttons = [[
                 ...
                 InlineKeyboardButton("🗳 Deploy", url="https://www.youtube.com/channel/UCohk_mpuW8SpgZMyOzRdKcA"),
                ...
                buttons = [[
                 ...
                 InlineKeyboardButton("🗳 Deploy", url="url="https://www.youtube.com/channel/UCohk_mpuW8SpgZMyOzRdKcA"),
                 InlineKeyboardButton("🤖 Update", url="https://t.me/HTDGROUPFORMOVIES")
                 ]]               
