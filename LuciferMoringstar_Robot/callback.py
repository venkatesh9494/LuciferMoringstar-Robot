...
# ---------- 📁 [ | 𝗠𝗢𝗗𝗨𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            if query.from_user.id not in ADMINS: 
                buttons = [[
                 ...
                 InlineKeyboardButton("🗳 Deploy", url="https://github.com/bossstory/LuciferMoringstar-Robot"),
                ...
                buttons = [[
                 ...
                 InlineKeyboardButton("🗳 Deploy", url="url="https://github.com/bossstory/LuciferMoringstar-Robot"),
                 InlineKeyboardButton("🤖 Update", url="https://t.me/HTDGROUPFORMOVIES")
                 ]]               
